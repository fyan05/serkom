        ...
        <nav class="col-md-2 sidebar d-none d-md-block position-fixed">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{ route('operator.index') }}">
                ...
                {{-- ...menu lainnya... --}}
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{ route('operator.user') }}">
                        <i class="fas fa-user me-2" style="font-size: 1rem;"></i>
                        User
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{ route('operator.siswa') }}">
                        <i class="fas fa-users me-2" style="font-size: 1rem;"></i>
                        Daftar Siswa
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{route('operator.guru')}}">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{ route('operator.profile') }}">
                        <i class="fas fa-school me-2" style="font-size: 1rem;"></i>
                        Porfile
                    </a>
                </li>
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link d-flex align-items-center" href="{{ route('operator.ekstrakulikuler') }}">
        ...
        <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
            ...
            <div class="offcanvas-body p-0">
                <ul class="navbar-nav me-auto">
                    {{-- Menu sidebar mobile --}}
                    <li class="nav-item d-flex align-items-center">
                        <a class="nav-link d-flex align-items-center" href="/operator/home">
                            <i class="fas fa-home me-2" style="font-size: 1rem;"></i>
                            Dashboard
                        </a>
                    </li>
